...
*/
  ...
  //Expert signup
  //========================
  if ($("#subscriptionsforms1").length > 0) {
    $("#subscriptionsforms1").on("submit", function(e) {
      e.preventDefault();
      var sub_email = $("#sub_email1").val();
      $("#sub_submit1").html("Processing...");
      if (sub_email == "") {
        $("#sub_email1").addClass("reqError");
        $("#sub_submit1").html("Failed!");
      } else {
        $("#sub_email1").removeClass("reqError");
        $.ajax({
          type: "POST",
          url: "php/subscription.php",
  ...
  //=================================================
  //sbuscription bottom signup
  //===================================================
  if ($("#subscriptionsforms2").length > 0) {
    $("#subscriptionsforms2").on("submit", function(e) {
      e.preventDefault();
      var sub_email = $("#sub_email2").val();
      $("#sub_submit2").html("Processing...");
      if (sub_email2 == "") {
